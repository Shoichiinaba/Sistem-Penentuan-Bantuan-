    ...
    <head>
        ...
        <!-- title -->
          <?php if ($userdata->level=='2') { ?>
              <link rel="shortcut icon" type="image/x-icon" href="<?php echo base_url(); ?>assets/img/dinsos3.png">
              <title>Sistem Penentuan Bantuan  | Bedah Rumah</title>
              <?php } elseif ($userdata->level=='1' ) { ?>
              <link rel="shortcut icon" type="image/x-icon" href="<?php echo base_url(); ?>assets/img/dinsos3.png">
              <title>Sistem Bantuan DINSOS  | Approvment</title>
          <?php } else { ?>
