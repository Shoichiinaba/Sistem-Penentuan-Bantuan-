...
<html>
    <head>
        ...
        <link rel="shortcut icon" href="assets/img/dinsos1.png" type="image/x-icon">
        <!-- Bootstrap 3.3.2 -->
 ...
 echo "<style>
    body{
        background-image:url(".base_url()."assets/img/beckround/bglog.jpg);
    ...
    <body >
        <div class="login-box">
            <div class="login-logo">
                <small>
                            <img src="assets/img/dinsos3.png" alt="" />
                        </small>

                <a href="" > <b class= "text-yellow">Login</b> <i class="text-green">Admin </i></a>
            </div><!-- /.login-logo -->
